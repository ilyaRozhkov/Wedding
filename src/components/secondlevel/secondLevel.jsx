...
export const SecondLevel = () =>{
    ...
    return (
        ...
        whileInView={'timeOutPagesVisible'} className='second-level-container'>
            ...
            <motion.div custom={2} variants={animationStyle} className='second-level-text'>Один день в этом году будет для нас особенным и мы хотим провести его в кругу близких и друзей. С большим удовольствием приглашаем вас на знаменательный праздник - нашу свадьбу!</motion.div>
        </motion.div>
    )
}