    ...
    return (
        ...
        whileInView={'timeOutPagesVisible'}   viewport={{ once: true }} className='detail-container'>
            ...
            <motion.div custom={2} variants={animationStyle} className='detail-item-container'>
                <motion.div custom={2} variants={animationStyle} className='detail-item-item'>Главное для нас - ваше присутствие.
                ...
                <motion.div custom={3} variants={animationStyle} className='detail-item-split'><Flower style={{width: '30px', height: '30px'}}/></motion.div>
                <motion.div custom={3} variants={animationStyle} className='detail-item-item'>Вы можете не переживать по поводу подарка, любая комфортная для вас сумма в конверте приблизит нас к мечте!</motion.div>
                <motion.div custom={4} variants={animationStyle} className='detail-item-split'><Flower style={{width: '30px', height: '30px'}}/></motion.div>
                <motion.div custom={4} variants={animationStyle} className='detail-item-item'>К великому сожалению, в ресторане нет детских зон и нет возможности пригласить аниматоров для того, чтобы занять самых маленьких наших гостей, потому просим заранее подумать о том, с кем оставить Вашу кроху на праздничный вечер.</motion.div>
            </motion.div>
        </motion.div>
    )
}