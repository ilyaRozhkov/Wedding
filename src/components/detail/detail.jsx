    ...
    return (
        ...
        whileInView={'timeOutPagesVisible'}   viewport={{ once: true }} className='detail-container'>
            ...
            <motion.div custom={2} variants={animationStyle} className='detail-item-container'>
                ...
                <motion.div custom={5} variants={animationStyle} className='detail-item-item'>Если хотите подарить нам ценный и нужный подарок, мы будем очень благодарны за вклад в бюджет нашей молодой семьи.</motion.div>
